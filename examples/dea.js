...
*/
        ...
        // Named layer displaying Average Temperature data
        var layerName1 = "landsat5_nbart_16day";
        var layerName2 = "landsat7_nbar_16day";
        var layerName3 = "landsat8_nbar_16day";
        var layerName4 = "hltc_high";
        var layerName5 = "landsat5_geomedian";
        ...
        var createLayer1 = function (xmlDom) {
            ...
            var wmsConfig = WorldWind.WmsLayer.formLayerConfiguration(wmsLayerCapabilities);
            // Modify the configuration objects title property to a more user friendly title
            wmsConfig.title = "Landsat 5 TCSR";
            // Create the WMS Layer from the configuration object
            var wmsLayer = new WorldWind.WmsLayer(wmsConfig);
        ...
        var createLayer2 = function (xmlDom) {
            ...
            var wmsConfig = WorldWind.WmsLayer.formLayerConfiguration(wmsLayerCapabilities);
            // Modify the configuration objects title property to a more user friendly title
            wmsConfig.title = "Landsat 7 surface reflectance";
            // Create the WMS Layer from the configuration object
            var wmsLayer = new WorldWind.WmsLayer(wmsConfig);
            wmsLayer.enabled = false;
        ...
        var createLayer3 = function (xmlDom) {
            ...
            var wmsConfig = WorldWind.WmsLayer.formLayerConfiguration(wmsLayerCapabilities);
            // Modify the configuration objects title property to a more user friendly title
            wmsConfig.title = "Landsat 8 surface reflectance";
            // Create the WMS Layer from the configuration object
            var wmsLayer = new WorldWind.WmsLayer(wmsConfig);
            wmsLayer.enabled = false;
        ...
        var createLayer4 = function (xmlDom) {
            ...
            var wmsConfig = WorldWind.WmsLayer.formLayerConfiguration(wmsLayerCapabilities);
            // Modify the configuration objects title property to a more user friendly title
            wmsConfig.title = "High Tide Composite";
            // Create the WMS Layer from the configuration object
            var wmsLayer = new WorldWind.WmsLayer(wmsConfig);
            wmsLayer.enabled = false;
        ...
        var createLayer5 = function (xmlDom) {
            ...
            var wmsConfig = WorldWind.WmsLayer.formLayerConfiguration(wmsLayerCapabilities);
            // Modify the configuration objects title property to a more user friendly title
            wmsConfig.title = "Landsat 5 TCSR geometric median";
            // Create the WMS Layer from the configuration object
            var wmsLayer = new WorldWind.WmsLayer(wmsConfig);
